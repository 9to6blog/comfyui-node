...
두 노드는 9to6 Multi Prompt Switcher와 같은 다크 카드·주황 강조색·SVG 아이콘으로 통일했습니다. 각 노드는 원하는 크기로 리사이즈할 수 있으며, 공간이 좁을 때 목록이나 결과 그리드만 내부 스크롤됩니다.
...
- 선택 목록에서 SVG 위·아래 버튼으로 순서를 바꾸고 삭제 버튼으로 개별 항목을 제외할 수 있습니다.
